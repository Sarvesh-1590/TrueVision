...
=======
# TrueVision
TrueVision is a full-stack application designed to detect manipulated media in both images and videos. Built with a Java backend and a modern web/GUI frontend, TrueVision leverages deep learning to identify deepfake content while providing an intuitive dashboard for users to analyze results in real time.
>>>>>>> 0ac18da3bd969d9eae126de8529006aaa1b27b2e
